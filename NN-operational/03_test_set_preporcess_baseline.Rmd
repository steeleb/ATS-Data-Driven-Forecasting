...
# import test data
t2022_fn = os.path.join(file_path, "test_3h_2022_v2024-10-28.csv")
t2022 = pd.read_csv(t2022_fn, sep=',')
t2023_fn = os.path.join(file_path, "test_3h_2023_v2024-10-28.csv")
...
```{python}
h2022_fn = os.path.join(file_path, "data_handle_tracking_t2022_v2024-11-25.csv")
handle_2022 = pd.read_csv(h2022_fn, sep=',', index_col=0)
handle_2022 = handle_2022.set_index("column")

h2023_fn = os.path.join(file_path, "data_handle_tracking_t2023_v2024-10-28.csv")
...
mean_std_t2022 = pd.read_csv(os.path.join(file_path, "mean_std_train_val_t2022_v2024-11-25.csv"), sep=',')
...
```{python}
# save the file
fn = os.path.join(file_path, "t2022_standardized_v2024-11-25.csv")
t2022_standard.to_csv(fn, index=False)

fn = os.path.join(file_path, ("t2023_standardized_v2024-11-25.csv"))
