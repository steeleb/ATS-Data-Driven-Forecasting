...
write_feather(gefs_2021, "data/forecasts/gefs_2021.feather")
...
write_feather(gefs_2022, "data/forecasts/gefs_2022.feather")
...
write_feather(gefs_2023, "data/forecasts/gefs_2023.feather")
