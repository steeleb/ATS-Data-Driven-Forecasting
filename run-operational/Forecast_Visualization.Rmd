...
```{r}
one_m <- ggplot(make_forecast_summary(forecast_07072022_7), aes(x = date)) +
  geom_ribbon(aes(ymin = min_1m_temp, ymax = max_1m_temp), fill = "grey") +
  geom_point(data = filter_obs_data(obs, "2022-07-07", 6), aes(x = date, y = mean_1m_temp_degC))  +
  theme_bw()

int_m <- ggplot(make_forecast_summary(forecast_07072022_7), aes(x = date)) +
  geom_ribbon(aes(ymin = min_0_5m_temp, ymax = max_0_5m_temp), fill = "grey") +
  geom_point(data = filter_obs_data(obs, "2022-07-07", 6), aes(x = date, y = mean_0_5m_temp_degC))  +
  theme_bw()
...
```{r}
one_m <- ggplot(make_forecast_summary(forecast_09112022_7), aes(x = date)) +
  geom_ribbon(aes(ymin = min_1m_temp, ymax = max_1m_temp), fill = "grey") +
  geom_point(data = filter_obs_data(obs, "2022-09-11", 6), aes(x = date, y = mean_1m_temp_degC))  +
  theme_bw()

int_m <- ggplot(make_forecast_summary(forecast_09112022_7), aes(x = date)) +
  geom_ribbon(aes(ymin = min_0_5m_temp, ymax = max_0_5m_temp), fill = "grey") +
  geom_point(data = filter_obs_data(obs, "2022-09-11", 6), aes(x = date, y = mean_0_5m_temp_degC))  +
  theme_bw()
