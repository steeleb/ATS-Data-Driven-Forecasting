...
ggplot() +
  geom_point(data = obs_2022, aes(x = date, y = mean_1m_temp_degC)) +
  geom_ribbon(data = forecast_min_max, aes(x = valid_date, ymin = min_1m_temp, ymax = max_1m_temp, fill = forecast_date), alpha = 0.2) +
  geom_line(data = forecast_mean, aes(x = valid_date, y = mean_1m, color = forecast_date)) +
  theme_bw() +
  theme(legend.position = "none")

ggplot() +
  geom_point(data = obs_2022, aes(x = date, y = mean_0_5m_temp_degC)) +
  geom_ribbon(data = forecast_min_max, aes(x = valid_date, ymin = min_0_5m_temp, ymax = max_0_5m_temp, fill = forecast_date), alpha = 0.2) +
  geom_line(data = forecast_mean, aes(x = valid_date, y = mean_int, color = forecast_date)) +
  theme_bw() +
  theme(legend.position = "none")
