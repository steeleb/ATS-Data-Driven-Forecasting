...
control_forecast_2023 <- control_forecast_files[grepl('2023', control_forecast_files)]
dates <- str_extract(control_forecast_2023, "\\d{4}-\\d{2}-\\d{2}")
control_forecasts <- map2(.x = control_forecast_2023,
                          .y = dates,
                          .f = ~read_csv(.x) %>% 
